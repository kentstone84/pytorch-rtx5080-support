...
Copy and paste this when creating your GitHub Release!
...
**Option 1: Single File** (if your .whl is under 2GB)
- `pytorch-2.10.0a0-sm120-win_amd64.whl`

**Option 2: Split Archive** (if over 2GB)
- `pytorch-2.10.0a0-sm120-win_amd64.7z.001`
- `pytorch-2.10.0a0-sm120-win_amd64.7z.002`
- `pytorch-2.10.0a0-sm120-win_amd64.7z.003`

Extract with 7-Zip, then install:
```powershell
pip install pytorch-2.10.0a0-sm120-win_amd64.whl
```
...
See [RELEASE_NOTES.md](RELEASE_NOTES.md#known-issues) for workarounds.
